...
description: "Demo report to showcase quarto and R functionality"
code-tools: true
---
...
More figure options and layouts are described [here](https://quarto.org/docs/authoring/figures.html).
...
Markdown tables can be enchanced using the R package [htmlTable](https://github.com/gforge/htmlTable).
...
reactable creation can be simplified as well as enchanced by using [reactablefmtr](https://github.com/kcuilla/reactablefmtr/).
